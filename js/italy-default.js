...
if (isIE() < 9 && isIE() != false) {
    $("head").append('<link rel="stylesheet" type="text/css" href="https://www.aig.co.it/Chartis/internet/Italy/Italian/ie-italy_tcm4011-656582.css" />');
}
...
$(document).ready(function(){
    ...
    $('.popBox, .carBackBtn, .offerLink').remove();
